...
- แอปที่ยังใช้บัญชีคนละชุด (นับสต๊อก `sc_users` · ครัวกลาง+ซ่อมบำรุง `app_users`/Supabase Auth) อยู่ในรายการ `ALWAYS` = **แสดงเสมอ** ล็อกอินกลางยังคุมไม่ถึง ต้องล็อกอินในแอปนั้นเอง
- **ทุกแอปต้องมีประตูของตัวเอง** (เจ้าของสั่ง 2026-09-21): เปิด URL ของแอปตรง ๆ โดยไม่มีใบผ่าน = ต้องใส่ user/pass ก่อนเสมอ — คนที่ได้ลิงก์ไปเฉย ๆ ต้องเข้าไม่ได้ · เขียนแอปใหม่ต้องใส่ประตูตั้งแต่แรก
  · KPI เป็นแอปสุดท้ายที่ยังเปิดโล่ง — ใส่ประตูแล้ว 2026-09-21 (แดชบอร์ดล็อกอิน · `?kiosk=` ของลูกค้าหน้าร้านยังเปิดตามเดิม) ดู `kpi/CLAUDE.md`
