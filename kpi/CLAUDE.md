...
· ปุ่ม "ดูทั้งหมด N ครั้ง" เต็มความกว้างอยู่ท้ายการ์ด (เก็บสถานะใน `S.recentAll` · วาดใหม่เฉพาะการ์ด — `recentRows`)
· **ไม่ใช้กล่องเลื่อนซ้อนในการ์ดแล้ว** (2026-09-21 rev.2 — สกรอลบาร์ของระบบดูแปลกแยก + ซ้อนกับการเลื่อนหน้า/ลากลงรีเฟรชบนมือถือ)
  เลื่อนด้วยหน้าเว็บตามปกติ · สกรอลบาร์ทั้งแอปจัดธีมเองแล้ว (`::-webkit-scrollbar` + `scrollbar-color` — บาง มน ไม่มีปุ่มลูกศร)
· จอ ≤620px ตารางกลายเป็นการ์ดต่อรายการ: แถวบน = เวลา + ชื่อพนักงาน(ชิดขวา) · แถวล่าง = ไอคอนแผนก+หน้ายิ้ม (`td.rc-faces`)
  — คอลัมน์รายแผนก (`td.face-cell`) ถูกซ่อนบนจอแคบ และ `.rc-faces` ถูกซ่อนบนจอกว้าง **ห้ามลืมซ่อนฝั่งใดฝั่งหนึ่ง ไม่งั้นอีโมจิขึ้นซ้ำ**
