...
setTimeout(async()=>{
  ...
  out.push('กล่อง: เข้าธนาคารแล้ว ฿338,726.70: '+[...d.querySelectorAll('#view-recon .pcell')].some(x=>x.textContent.includes('เข้าธนาคารแล้ว')&&x.textContent.includes('฿338,726.70')));
