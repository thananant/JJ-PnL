...
- กติกาเจ้าของ (2026-09-08): ไฟล์ `.sql` ที่เจ้าของต้องรันใน Supabase → **ส่งไฟล์ให้ในแชทโดยตรง** (SendUserFile) เจ้าของจะได้ไม่ต้องไปหาใน GitHub — ยังเก็บสำเนาที่ branch `sql` ตามเดิม · ส่วนงานที่ต้องอัพขึ้น GitHub ให้ push/merge เองเลย ไม่ต้องส่งไฟล์มาให้
